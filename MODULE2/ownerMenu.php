	...
	if ($resultCheck>0){
		while($row = $result->fetch_assoc()) {
            ...
            <tr>
                            ...
                            <td align="center">
                             <a href="delete.php?id=<?php echo $row["id"]; ?>"><img src ="images/remove (1).png" width="30px" height="30px" ></a>
                            </td>
                            </tr>
                            <?php
              }
...
-->
    ...
    <div style="margin-top: 5%;text-align: center;" >
                <a href="menureg.php" class="btn-1">Update </a>
            </div>
