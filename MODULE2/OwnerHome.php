...
if (isset($_POST['create'])){
  ...
  $sql = "INSERT INTO restdetails (restname, location, contact, operation, picture)
  VALUES ('$restname', '$location', '$contact', '$operation', '$picture')";
  
  if ($conn->query($sql) === TRUE) {
    header("Location: OwnerHome.php", true, 301);
...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Register Your Restaurant</h2>
                    ...
                    <form  method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Restaurant Operation</label>
