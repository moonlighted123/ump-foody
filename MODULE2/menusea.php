...
<head>
    ...
    <link rel="stylesheet" href="menusea.css?v=<?php echo time(); ?>">
...
<div class="sidenav">
    ...
    <div class="flex-container">
        ...
        <p style="margin-right: 5%;margin-left:5%;"> <a href="menudes.php" class="btn">Dessert</a></p>
        <a href="" class="btn active">Seafood</a>
    </div>
	...
	if ($resultCheck>0){
		while($row = $result->fetch_assoc()) {
            ...
            <tr>
                            ...
                            <td align="center">
                             <a href="deletesea.php?id=<?php echo $row["id"]; ?>"><img src ="images/remove (1).png" width="30px" height="30px" ></a>
                            </td>
                            </tr>
                            <?php
              }
...
-->
    ...
    <div style="margin-top: 5%;text-align: center;" >
                <a href="updatesea.php" class="btn-1">Update </a>
            </div>
