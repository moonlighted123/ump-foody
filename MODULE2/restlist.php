...
<div class="sidenav">
    ...
    <div style="margin-top: 3%;" class="header">
        <h1 style="text-align:center;">Restaurants Information</h1>
	...
	if ($resultCheck>0){
		while($row = $result->fetch_assoc()) {
            ...
            <tr>
                            ...
                            <td align="center">
                             <a href="deleterest.php?id=<?php echo $row["id"]; ?>"><img src ="images/remove (1).png" width="30px" height="30px" ></a>
                             <a href="updaterest.php?id=<?php echo $row["id"]; ?>"><img src ="images/contract.png" width="30px" height="30px" ></a>
                            </td>
                            </tr>
                            <?php
              }
...
-->
    ...
    <div style="margin-top: 5%;text-align: center;" >
                <a href="OwnerHome.php" class="btn-1">Update </a>
            </div>
