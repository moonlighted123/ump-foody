<?php   
 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="MalaysianFood.php"</script>';  
           }  
      }  
      else  
      {  
 ...
 <html>  
    ...
    <div class="flex-container">
        <p><a href="MalaysianFood.php" class="btn  active">Malaysian Food </a> </p>
        <p style="margin-right: 5%;margin-left:5%;"> <a href="dessert.php" class="btn">Dessert</a></p>
        <a href="seafood.php" class="btn">Seafood</a>
    </div>

           <br />  
           <div class="container" style="width:700px;">  
                <h3 align="center">MENU LIST</h3><br />  
                <?php  
                $query = "SELECT * FROM menureg ORDER BY id ASC";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="MalaysianFood.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                               <img src="<?php echo $row["picture"]; ?>" width="150px" height="150px" /><br />  
                ...
                <br />  
                <div class="btn-1" style="color: black; border-radius: 10px;"> 
                ...
                <div class="table-responsive" style=" margin-left: auto;margin-right: auto;">   
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="MalaysianFood.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
