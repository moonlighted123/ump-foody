<?php   
 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="dessert.php"</script>';  
           }  
      }  
      else  
      {  
 ...
 <html>  
    ...
    <div class="flex-container">
        <p><a href="MalaysianFood.php" class="btn">Malaysian Food </a> </p>
        <p style="margin-right: 5%;margin-left:5%;"> <a href="dessert.php" class="btn active">Dessert</a></p>
        <a href="seafood.php" class="btn">Seafood</a>
           ...
           <div class="container" style="width:700px;">  
                ...
                <?php  
                $query = "SELECT * FROM regdes ORDER BY id ASC";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="dessert.php?action=add&id=<?php echo $row["id"]; ?>">  
                ...
                <div class="table-responsive" style=" margin-left: auto;margin-right: auto;">   
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="dessert.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
