...
if (count($_POST) > 0) {
    mysqli_query($conn, "UPDATE complaint set ComplaintID ='" . $_POST['ComplaintID'] . "', Name='" . $_POST['name'] . "', description='" . $_POST['desc'] . "', complaint_type='" . $_POST['type'] . "' WHERE ComplaintID='" . $_POST['ComplaintID'] . "'");
