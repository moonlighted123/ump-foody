...
$sql = "INSERT INTO `complaint` (`ComplaintID`, `Name`, `description`, `complaint_type`, `datetime`,`complaint_status`) VALUES ('0', '$txtName', '$txtDesc', '$txtType', current_timestamp(), '$complaint_status')";
