...
<div class="sidenav">
            ...
            <div class="row">
                <div class="offer">
                    <div class="small-container">
                        <div class="row">
                            <div class="col-2">
                                <h1 style="color: black;">PICK UP</h1>
 ...
 <?php
$count=1;
$sel_query="SELECT * from rider ORDER BY id desc;";
$result = mysqli_query($conn,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr><td align="center"><?php echo $count; ?></td>
<td align="center"><?php echo $row["namecust"]; ?></td>
<td align="center"><?php echo $row["addcust"]; ?></td>
<td align="center"><?php echo $row["pricefood"]; ?></td>
<td align="center">
<a href="complete.php?id=<?php echo $row["id"]; ?>" target="popup" 
  onclick="window.open('complete.php','popup','width=600,height=600'); return false;">
    DELIVERED</a>
</td>
